...
\resumeSubheading
    {Smart RAG Agent with Research Crawler, Comcast Challenge Winner}{Mar. 2025}
    {Hackathon: Philly Codefest}{Philadelphia, PA}
    \resumeItemListStart
      \resumeItem{Developed SmartSearchAI, an intelligent service comparison platform that secured first place in the Comcast Challenge at Philly Codefest, leveraging Retrieval-Augmented Generation (RAG) for efficient indexing and real-time data retrieval.}
      \resumeItem{Engineered a personalized AI recommendation system using Claude 3.7 Sonnet for natural language query processing, dynamically tailoring service bundle suggestions based on user preferences.}
      \resumeItem{Integrated market-aware decision-making with Perplexity-based analysis, enabling precise comparisons of competing services to maximize consumer value.}
      \resumeItem{Designed and deployed a React-based frontend with an intuitive chat interface, complemented by a Flask backend hosted on AWS EC2, ensuring scalable and seamless user interactions.}
    \resumeItemListEnd
...
\begin{tabular}{p{0.99\linewidth}}
    ...
    \hspace{0.15in}\textbf{Coordinator}, BITS-2-BYTES, 2K22
        \hfill \textbf{Sep. 2022}
\end{tabular}
